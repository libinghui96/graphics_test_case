...
// the order of points should be in consistence with it in tessellation shaders
// 
// 1) 4 control points form a rectangle.
//       u=0          u=1
// v=0   (0)----------(3)
//        |            |
//        |            |
// v=1   (1)----------(2)
//           a = mix(p0, p3, u) // a = p0 * (1 - u) + p3 * u => a = u * (p0 - p3)
//           b = mix(p1, p2, u)
// gl_Position = mix(a, b, v)
// 
// 2) 4 control points form a parallelogram.
//       (0)----------(3)
//      /     /      /
//     /-----p------/
//    /     /      /
//  (1)----------(2)
// 
// 3) 4 control points form a irregular quadrilateral.
const std::vector<Vertex> vertices = {
    {{-0.5f, -0.5f, 0.0f}, {1.0f, 0.0f, 0.0f, 0.5f}, {0.0f, 0.0f}},
...
private:
    ...
    void createLogicalDevice() {
        ...
        if (deviceFeatures.tessellationShader != VK_TRUE) {
            throw std::runtime_error("device not support tessellation shader!");
        }
    ...
    void createGraphicsPipeline() {
        ...
        // VK_PRIMITIVE_TOPOLOGY_PATCH_LIST must be set as IA topology for tessellation pipelines
